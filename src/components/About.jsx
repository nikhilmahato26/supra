    ...
    <section id="about" className="bg-light-cream py-24 lg:py-32">
      <div className="container-x grid items-center gap-14 lg:grid-cols-2">
        ...
        <div className="grid grid-cols-2 gap-5">
          {STATS.map((s, i) => (
            <Reveal key={s.label} delay={i * 0.08} variant="up" className="h-full">
              <div className="flex h-full flex-col justify-center rounded-3xl border border-brand/10 bg-white p-6 text-center shadow-card sm:p-8">
                <p className="font-display text-2xl text-brand break-words sm:text-3xl lg:text-4xl">
